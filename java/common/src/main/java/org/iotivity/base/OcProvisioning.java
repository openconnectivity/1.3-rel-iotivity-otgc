...
public class OcProvisioning {
	...
	/**
     * Method to Discover single device in its subnet.
     *
     * @param timeout     Timeout in sec.Time to listen for responses before
     ...
     *                     Use OcException.GetErrorCode() for more details.
     */
    public static native OcSecureResource discoverSingleDevice(int timeout, String deviceId) throws OcException;
    
    /**
     * Method to Discover single device with unicast in a specific host.
     *
     * @param timeout     Timeout in sec.Time to listen for responses before
     *                    returning the Object.
	 * @param deviceId	  ID of the device to be found.
	 * @param host        Address of the device.
	 * @param connType    Connectivity type to be used in the discovery.
     *
     * @return            OcSecureResource class object.
     *
     * @throws OcException Indicate discovery failure.
    ...
    /**
     * Method to provision an identity certificate.
     *
     * @param caCertPem CA certificate.
     * @param caKeyPem CA private key.
     *
     * @return CredId of saved identity certificate in Cred of SVR.
     *
     * @throws OcException Indicate failure to provision the identity certificate.
     *                     Use OcException.GetErrorCode() for more details.
     */
    public static int provisionOwnCert(byte[] caCertPem, byte[] caKeyPem) throws OcException {
        return provisionOwnCertificate(caCertPem, caKeyPem);
    }
    private static native int provisionOwnCertificate(byte[] caCertPem, byte[] caKeyPem)
        throws OcException;
     ...
     *
     * @param peerCnVerifyListener
     *
     * @throws OcException Indicate failure setting the PeerCnVerifyListener.
     *                     Use OcException.GetErrorCode() for more details.
     */
    public static native void setPeerCnVerifyListener(
            PeerCnVerifyListener peerCnVerifyListener) throws OcException;

    public static interface PeerCnVerifyListener {
        public int peerCnVerifyListener(String commonName);
    }
    
    /**
     * API to reset SVR DB.
     *
     *@throws OcException Indicate failure resetting SVR DB.
     */
    public static native void resetSvrDb() throws OcException;
}
