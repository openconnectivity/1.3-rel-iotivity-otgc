...
public class OicSecAce {
    private int aceID;
    private OicSecAceSubject subject;
    ...
    public OicSecAce(int aceID, OicSecAceSubject subject, int permission,
    ...
    public OicSecAceSubject getSubject() {
        return subject;
    }

    public void setSubject(OicSecAceSubject subject) {
        this.subject = subject;
    }
