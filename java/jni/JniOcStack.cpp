...
jclass g_cls_OcOicSecAcl_ace_subject = nullptr;
jclass g_cls_OcOicSecAcl_ace_subject_role = nullptr;
...
jclass g_cls_OcOicSecCreds = nullptr;
jclass g_cls_OcOicSecCreds_cred = nullptr;
jclass g_cls_OcOicSecCreds_cred_role = nullptr;
...
jmethodID g_mid_OcOicSecAcl_ctor = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_ctor = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_subject_ctor = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_subject_role_ctor = nullptr;
jmethodID g_mid_OcOicSecAcl_resr_ctor = nullptr;
#ifdef WITH_CLOUD
...
jmethodID g_mid_OcOicSecAcl_set_aces = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_get_aceid = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_set_aceid = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_get_subject = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_set_subject = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_get_subject_uuid = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_subject_get_type = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_subject_get_role = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_subject_role_get_id = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_subject_role_get_authority = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_subject_get_connType = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_get_permissions = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_set_permissions = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_get_resources = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_set_resources = nullptr;
jmethodID g_mid_OcOicSecAcl_ace_get_validities = nullptr;
jmethodID g_mid_OcOicSecAcl_resr_get_href = nullptr;
jmethodID g_mid_OcOicSecAcl_resr_set_href = nullptr;
jmethodID g_mid_OcOicSecAcl_resr_get_rel = nullptr;
jmethodID g_mid_OcOicSecAcl_resr_set_rel = nullptr;
...
jmethodID g_mid_OcOicSecAcl_set_rownerID = nullptr;
...
jmethodID g_mid_OcOicSecCreds_ctor = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_ctor = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_role_ctor = nullptr;
jmethodID g_mid_OcOicSecCreds_get_rownerID = nullptr;
jmethodID g_mid_OcOicSecCreds_set_rownerID = nullptr;
jmethodID g_mid_OcOicSecCreds_get_creds = nullptr;
jmethodID g_mid_OcOicSecCreds_set_creds = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_get_credid = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_set_credid = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_get_credtype = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_set_credtype = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_get_credusage = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_set_credusage = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_set_subject = nullptr;
jmethodID g_mid_OcOicSecCreds_cred_set_role = nullptr;
...
JNI_OnLoad(JavaVM* vm, void* reserved)
{
	...
	g_mid_OcOicSecAcl_ctor = env->GetMethodID(g_cls_OcOicSecAcl, "<init>", "()V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ctor);
    ...
    g_mid_OcOicSecAcl_set_rownerID = env->GetMethodID(g_cls_OcOicSecAcl, "setRownerID", "(Ljava/lang/String;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_set_rownerID);
    ...
    g_mid_OcOicSecAcl_set_aces = env->GetMethodID(g_cls_OcOicSecAcl, "setOicSecAces", "(Ljava/util/List;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_set_aces);
    ...
    g_mid_OcOicSecAcl_ace_ctor = env->GetMethodID(g_cls_OcOicSecAcl_ace, "<init>", "()V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_ctor);

	g_mid_OcOicSecAcl_ace_get_aceid = env->GetMethodID(g_cls_OcOicSecAcl_ace, "getAceID","()I");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_get_aceid);
    
    g_mid_OcOicSecAcl_ace_set_aceid = env->GetMethodID(g_cls_OcOicSecAcl_ace, "setAceID","(I)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_set_aceid);

    g_mid_OcOicSecAcl_ace_get_subject = env->GetMethodID(g_cls_OcOicSecAcl_ace, "getSubject","()Lorg/iotivity/base/OicSecAceSubject;");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_get_subject);
    
    g_mid_OcOicSecAcl_ace_set_subject = env->GetMethodID(g_cls_OcOicSecAcl_ace, "setSubject","(Lorg/iotivity/base/OicSecAceSubject;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_set_subject);
    ...
    g_mid_OcOicSecAcl_ace_set_permissions = env->GetMethodID(g_cls_OcOicSecAcl_ace, "setPermission","(I)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_set_permissions);
    ...
    g_mid_OcOicSecAcl_ace_set_resources = env->GetMethodID(g_cls_OcOicSecAcl_ace, "setResources","(Ljava/util/List;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_set_resources);
    ...
    //OicSecAceSubject
    clazz = env->FindClass("org/iotivity/base/OicSecAceSubject");
    VERIFY_VARIABLE_NULL(clazz);
    g_cls_OcOicSecAcl_ace_subject =  (jclass)env->NewGlobalRef(clazz);
    env->DeleteLocalRef(clazz);
    
    g_mid_OcOicSecAcl_ace_subject_ctor = env->GetMethodID(g_cls_OcOicSecAcl_ace_subject, "<init>", "(ILjava/lang/String;Lorg/iotivity/base/AceSubjectRole;Ljava/lang/String;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_subject_ctor);
    
    g_mid_OcOicSecAcl_ace_get_subject_uuid = env->GetMethodID(g_cls_OcOicSecAcl_ace_subject, "getUuid","()Ljava/lang/String;");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_get_subject_uuid);
    
    g_mid_OcOicSecAcl_ace_subject_get_type = env->GetMethodID(g_cls_OcOicSecAcl_ace_subject, "getIntSubjectType", "()I");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_subject_get_type);
    
    g_mid_OcOicSecAcl_ace_subject_get_role = env->GetMethodID(g_cls_OcOicSecAcl_ace_subject, "getRole", "()Lorg/iotivity/base/AceSubjectRole;");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_subject_get_role);
    
    g_mid_OcOicSecAcl_ace_subject_get_connType = env->GetMethodID(g_cls_OcOicSecAcl_ace_subject, "getConnType", "()Ljava/lang/String;");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_subject_get_connType);
    
    //AceSubjectRole
    clazz = env->FindClass("org/iotivity/base/AceSubjectRole");
    VERIFY_VARIABLE_NULL(clazz);
    g_cls_OcOicSecAcl_ace_subject_role = (jclass)env->NewGlobalRef(clazz);
    env->DeleteLocalRef(clazz);
    
    g_mid_OcOicSecAcl_ace_subject_role_ctor = env->GetMethodID(g_cls_OcOicSecAcl_ace_subject_role, "<init>", "(Ljava/lang/String;Ljava/lang/String;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_subject_role_ctor);
    
    g_mid_OcOicSecAcl_ace_subject_role_get_id = env->GetMethodID(g_cls_OcOicSecAcl_ace_subject_role, "getId", "()Ljava/lang/String;");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_subject_role_get_id);
    
    g_mid_OcOicSecAcl_ace_subject_role_get_authority = env->GetMethodID(g_cls_OcOicSecAcl_ace_subject_role, "getAuthority", "()Ljava/lang/String;");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_ace_subject_role_get_authority);    
    ...
    g_mid_OcOicSecAcl_resr_ctor = env->GetMethodID(g_cls_OcOicSecAcl_resr, "<init>", "()V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_resr_ctor);
    ...
    g_mid_OcOicSecAcl_resr_set_href = env->GetMethodID(g_cls_OcOicSecAcl_resr, "setHref","(Ljava/lang/String;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_resr_set_href);
    ...
    g_mid_OcOicSecAcl_resr_set_rel = env->GetMethodID(g_cls_OcOicSecAcl_resr, "setRel","(Ljava/lang/String;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecAcl_resr_set_rel);
    ...
    // OicSecCreds
    clazz = env->FindClass("org/iotivity/base/OicSecCreds");
    VERIFY_VARIABLE_NULL(clazz);
    g_cls_OcOicSecCreds = (jclass)env->NewGlobalRef(clazz);
    env->DeleteLocalRef(clazz);
    
    g_mid_OcOicSecCreds_ctor = env->GetMethodID(g_cls_OcOicSecCreds, "<init>", "()V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_ctor);
    
    g_mid_OcOicSecCreds_get_rownerID = env->GetMethodID(g_cls_OcOicSecCreds, "getRownerID", "()Ljava/lang/String;");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_get_rownerID);
    
    g_mid_OcOicSecCreds_set_rownerID = env->GetMethodID(g_cls_OcOicSecCreds, "setRownerID", "(Ljava/lang/String;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_set_rownerID);

    g_mid_OcOicSecCreds_get_creds = env->GetMethodID(g_cls_OcOicSecCreds, "getOicSecCreds", "()[Lorg/iotivity/base/OicSecCred;");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_get_creds);
    
    g_mid_OcOicSecCreds_set_creds = env->GetMethodID(g_cls_OcOicSecCreds, "setOicSecCreds", "(Ljava/util/List;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_set_creds);
    
    // OicSecCred
    clazz = env->FindClass("org/iotivity/base/OicSecCred");
    VERIFY_VARIABLE_NULL(clazz);
    g_cls_OcOicSecCreds_cred =  (jclass)env->NewGlobalRef(clazz);
    env->DeleteLocalRef(clazz);
    
    g_mid_OcOicSecCreds_cred_ctor = env->GetMethodID(g_cls_OcOicSecCreds_cred, "<init>", "()V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_ctor);

	g_mid_OcOicSecCreds_cred_get_credid = env->GetMethodID(g_cls_OcOicSecCreds_cred, "getCredID","()I");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_get_credid);
    
    g_mid_OcOicSecCreds_cred_set_credid = env->GetMethodID(g_cls_OcOicSecCreds_cred, "setCredID","(I)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_set_credid);
    
    /*g_mid_OcOicSecCreds_cred_get_credtype = env->GetMethodID(g_cls_OcOicSecCreds_cred, "getCredType","()I");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_get_credtype);*/
    
    g_mid_OcOicSecCreds_cred_set_credtype = env->GetMethodID(g_cls_OcOicSecCreds_cred, "setCredType","(I)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_set_credtype);

    g_mid_OcOicSecCreds_cred_get_credusage = env->GetMethodID(g_cls_OcOicSecCreds_cred, "getCredUsage","()Ljava/lang/String;");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_get_credusage);
    
    g_mid_OcOicSecCreds_cred_set_credusage = env->GetMethodID(g_cls_OcOicSecCreds_cred, "setCredUsage","(Ljava/lang/String;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_set_credusage);
    
    g_mid_OcOicSecCreds_cred_set_subject = env->GetMethodID(g_cls_OcOicSecCreds_cred, "setSubject", "(Ljava/lang/String;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_set_subject);
    
    g_mid_OcOicSecCreds_cred_set_role = env->GetMethodID(g_cls_OcOicSecCreds_cred, "setRole", "(Lorg/iotivity/base/CredSubjectRole;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_set_subject);
    
    //CredSubjectRole
    clazz = env->FindClass("org/iotivity/base/CredSubjectRole");
    VERIFY_VARIABLE_NULL(clazz);
    g_cls_OcOicSecCreds_cred_role = (jclass)env->NewGlobalRef(clazz);
    env->DeleteLocalRef(clazz);
    
    g_mid_OcOicSecCreds_cred_role_ctor = env->GetMethodID(g_cls_OcOicSecCreds_cred_role, "<init>", "(Ljava/lang/String;Ljava/lang/String;)V");
    VERIFY_VARIABLE_NULL(g_mid_OcOicSecCreds_cred_role_ctor);
