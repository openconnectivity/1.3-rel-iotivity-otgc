...
class JniSecureUtils
{
    ...
    public:
        ...
        static jobject convertDeviceToJava(JNIEnv *env,
        ...
        static jobject convertOCAclToJavaACL(JNIEnv *env, OC::PMGetAclResult_t *aclResult);
        static jobject convertOCCredToJavaCred(JNIEnv *env, OC::PMGetCredsResult_t *credResult);
};
