...
/**
 * This method is used by provisioning manager to update id of the device.
 *
 * @param[in] oldUuid information about the target device's old uuid.
 * @param[in] newUuid information about the target device's new uuid.
 *
 * @return OC_STACK_OK in case of success and other value otherwise.
 */
