...
/**
 * API to delete ACE from resource by knowing its ID.
 *
 * @param[in] ctx Application context to be returned in result callback.
 * @param[in] selectedDeviceInfo Selected target device.
 ...
 * @param[in] ctx Application context to be returned in result callback.
 * @param[in] selectedDeviceInfo Selected target device.
 * @param[in] cred ID of the Credential to be deleted.
 * @param[in] resultCallback callback provided by API user, callback will be called when
 *            provisioning request receives a response from resource server.
 * @return OC_STACK_OK in case of success and other value otherwise.
 */
 ...
 * @param[in] ctx Application context to be returned in result callback.
 * @param[in] pDev Selected target device.
 * @param[in] role Role to provision.
 * @param[in] authority Authority for the role.
 * @param[in] resultCallback callback provided by API user, callback will be called when
 *            provisioning request receives a response from resource server.
 * @return OC_STACK_OK in case of success and other value otherwise.
 */
OCStackResult SRPProvisionIdentityOrRoleCertificate(void *ctx, const OCProvisionDev_t *pDev,
