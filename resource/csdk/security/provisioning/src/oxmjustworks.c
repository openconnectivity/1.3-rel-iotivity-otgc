    ...
    uint8_t **payload, size_t *size)
{
    ...
    *size = 0;
    ...
    return DoxmToCBORPayloadPartialWithRtAndIf(otmCtx->selectedDeviceInfo->doxm, payload, size, propertiesToInclude, false);
}
    ...
    uint8_t **payload, size_t *size)
{
    ...
    *size = 0;
    ...
    return DoxmToCBORPayloadPartialWithRtAndIf(otmCtx->selectedDeviceInfo->doxm, payload,
        size, propertiesToInclude, false);
}
                                             ...
                                             size_t *cborSize)
{
    ...
    *cborSize = 0;
    ...
    return DoxmToCBORPayloadPartialWithRtAndIf(otmCtx->selectedDeviceInfo->doxm, cborPayload,
        cborSize, propertiesToInclude, false);
}
