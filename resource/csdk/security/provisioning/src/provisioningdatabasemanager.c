...
#define PDM_SQLITE_UPDATE_UUID "UPDATE T_DEVICE_LIST SET UUID = ? WHERE UUID like ?"
#define PDM_SQLITE_UPDATE_UUID_SIZE (int)sizeof(PDM_SQLITE_UPDATE_UUID)
PDM_VERIFY_STATEMENT_SIZE(PDM_SQLITE_UPDATE_UUID);
