...
OCStackResult PstatToCBORPayloadPartialWithRtAndIf(const OicSecPstat_t *pstat,
                                        uint8_t **payload,
                                        size_t *size,
                                        const bool *propertiesToInclude,
                                        const bool includeDosP, const bool withRtAndIf)
{
...
{
    return PstatToCBORPayloadPartialWithRtAndIf(pstat, payload, size, propertiesToInclude, includeDosP, true);
}
