...
namespace OC
{
    ...
    typedef OCPMGetAclResult_t PMGetAclResult_t;
    typedef OCPMGetCredsResult_t PMGetCredsResult_t;
    typedef std::function<void(PMResultList_t *result, int hasError)> ResultCallBack;
    typedef std::function<void(PMGetAclResult_t *result, int hasError)> AclResultCallBack;
    typedef std::function<void(PMGetCredsResult_t *result, int hasError)> CredResultCallBack;
    ...
    struct GetAclContext
    {
        AclResultCallBack callback;
        GetAclContext(AclResultCallBack cb) : callback(cb){}
    };

    struct GetCredContext
    {
        CredResultCallBack callback;
        GetCredContext(CredResultCallBack cb) : callback(cb){}
    };
    ...
    class OCSecure
    {
        ...
        public:
            ...
            /**
             * API is responsible for discovery of devices in specified secure endpoint/deviceID.
             * And this function will only return the specified device's response.
             *
             * @param timeout Timeout in seconds, time until which function will listen to
             *                    responses from server before returning the specified device.
             ...
             * @param port      Secure port in the host.
             * @param connType  ConnectivityType for discovery.
             * @param foundDevice OCSecureResource object of found device.
             * @return ::OC_STACK_OK in case of success and other value otherwise.
             *         ::OC_STACK_INVALID_PARAM when deviceID is NULL or ppFoundDevice is not
             *                                  initailized.
             */
            static OCStackResult discoverSingleDeviceInSecureUnicast(bool filterOwnedByMe, unsigned short timeout,
                    const OicUuid_t* deviceID,
			 ...
			 * @return  OC_STACK_OK in case of success and other value otherwise.
			 */
			static OCStackResult OC_CALL provisionOwnCert(uint8_t *caCertPem, size_t caCertPemSize, uint8_t *caKeyPem, size_t caKeyPemSize, uint16_t *credId);
             ...
             *
             */
             static OCStackResult setPeerCNVerifyCallback(PeerCNVerifyCallback peerCnVerify);
    ...
    class OCSecureResource
    {
        ...
        public:
            ...
            /**
             * API to delete ACE from resource using its ID.
             *
             ...
             * @return ::OC_STACK_OK in case of success and other value otherwise.                            
             */
            OCStackResult deleteACE(uint16_t aceId,
                    ResultCallBack resultCallback);
            
            /**
             * API to get Cred resource from a device.
             *
             * @param resultCallback Callback will be called when provisioning request
             *                           receives a response from resource server.
             * @return  ::OC_STACK_OK in case of success and other value otherwise.
             */
            OCStackResult getCredResource(CredResultCallBack resultCallback);
             ...
             * @param resultCallback Callback provided by API user, callback will be called
             *        provisioning request receives a response from first resource server.
             * @return  ::OC_STACK_OK in case of success and other value otherwise.
             */
            OCStackResult provisionCertificate(const char* pemCert,
                    ResultCallBack resultCallback);
                    
            /**
             * API to provision an identity certificate to a device.
             *
             * @param pemCert Certificate to provision, encoded as PEM.
             * @param resultCallback Callback provided by API user, callback will be called
             *        provisioning request receives a response from first resource server.
             * @return  ::OC_STACK_OK in case of success and other value otherwise.
             */
            OCStackResult provisionIdentityCertificate(ResultCallBack resultCallback);
            
            /**
             * API to provision a role certificate to a device.
             *
             ...
             * @return  ::OC_STACK_OK in case of success and other value otherwise.
             */
            OCStackResult provisionRoleCertificate(const char* role, const char* authority, ResultCallBack resultCallback);
            
            /**
             * API to delete Cred from resource using its ID.
             *
             * @param credId ID of the Cred to be deleted.
             * @param resultCallback Callback will be called when provisioning request
             *                           receives a response from resource server.
             * @return ::OC_STACK_OK in case of success and other value otherwise.                            
             */
            OCStackResult deleteCred(uint16_t credId,
                    ResultCallBack resultCallback);
            ...
            */
            ...
            /**
             * API to reset the target device.
             ...
             * @return  ::OC_STACK_OK in case of success and other value otherwise.
             */
            OCStackResult resetDevice(unsigned short waitTimeForOwnedDeviceDiscovery,
                    ResultCallBack resultCallback);
            ...
            /**
             * This function returns the device's port.
             * @return device port.
             */
            uint16_t getDevPort();
            ...
            /**
             * This function provides the supported ownership transfer methods of the device.
             *
             * @param oxm Address to save the supported OxM.
             * @param oxmLen Address to save the number of elements in OxM.
             *
             * @return ::OC_STACK_OK in case of success and other value otherwise.
             */
            OCStackResult getSupportedOTMethods(OicSecOxm_t** oxm, size_t* oxmLen);
             ...
             * @param oxmSelVal Method of ownership transfer (ref. oic.sec.oxm)
             * @return  ::OC_STACK_OK in case of success and other value otherwise.
             */
            OCStackResult selectOTMethod( const OicSecOxm_t oxmSelVal,
                    ResultCallBack resultCallback);
					
			OCStackResult setOTMethod( const OicSecOxm_t oxmSelVal);
        ...
        private:
           ...
           /**
             * Get ACL callback wrapper.
             */
            static void getAclCallbackWrapper(void* ctx, OCPMGetAclResult_t *res, bool hasError);
            
           /**
             * Get Cred callback wrapper.
             */
            static void getCredCallbackWrapper(void* ctx, OCPMGetCredsResult_t *res, bool hasError);
